...
static struct i2c_adapter *bmp_i2c_adapter = NULL;  /* Adapter from driver to I2C Bus */
static struct i2c_client *bmp280_i2c_client = NULL; /* ClientL Our I2c device */
...
#define I2C_BUS_AVAILABLE		1  			/* The I2C available on the raspberry */
#define SLAVE_DEVICE_NAME		"BMP280"	/* Device and Driver Name */
#define BMP280_SLAVE_ADDRESS	0x76		/* BMP280 I2C adddress */
...
/**
 * @brief This function is called when the deice file is opened
 */
...
static int __init ModuleInit(void) {
	...
	bmp_i2c_adapter = i2c_get_adapter(I2C_BUS_AVAILABLE); /* adapter to get access to the bus*/
