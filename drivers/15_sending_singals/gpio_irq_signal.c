...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("LA");
MODULE_DESCRIPTION("Kernel Module which sebds a signal to an userspace app when GPIO 17 has a rising edge");

/* Variable contains pin number of interrupt controller to which GPIO 17 is mapped to */
unsigned int irq_number;

/* Globeal variables and defines for userspace app registration */
#define REGISTER_UAPP _IO('R', 'g')
static struct task_struct *task = NULL;  /* Stores info about userspace app */

/* define for singal sending */
#define SIGNR 44
...
/**
 * @brief IO control for registering the userspace app to the kernel module
 */
